...
class ProduitC{
    ...
    public function ajoutP($e){
        ...
        $sql='insert into  produits (id,nomproduit,prix,quantitee,couleur) VALUES (:id,:nom,:prix, :quantitee, :couleur)';
...
function modifier($e){
    ...
    $sql="UPDATE produits set nomproduit=:nom,prix=:prix,quantitee=:quantitee,couleur=:couleur where id=:id";
    //prepare our query
    $q=$db->prepare($sql);
