...
function afficherStat ($stat){
	...
	function ajouterStat($stat){
		$sql="insert into profits (id,year,purchase,sale,profit) values (:id, :year,:purchase,:sale,:profit)";
	...
	function modifierStat($stat,$id){
		$sql="UPDATE profits SET id=:idd, year=:year,purchase=:purchase,sale=:sale,profit=:profit WHERE id=:id";
