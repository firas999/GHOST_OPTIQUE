  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
       <form name="myform" action="recuperation/modifier_livraison.php" method="_GET">
              <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="text" name="id_client" value=""></td>
                    <td><input type="date" name="day" value=""></td>
                    <td><select name="etat" value="">
            ...
            <option value="Terminer"><i>Terminer</i></option>
                    ...
                    <td>
                    <input type="submit" class="btn btn-success btn-xs" name="Modifier" value="Modifier">
                    </td>
                  </tr>
                </tbody>
              </table>
         ...
         <input class="btn btn-success btn-xs" type="submit" value="rechercher">
                ...
                <table class="table table-bordered table-striped table-condensed">
                  ...
                  <tbody>
                    <?php
                    $a=0;
              $livreur5 = new livraison_core();
              $livreur4 = $livreur5->affiche_livraison(); 
            foreach($livreur4 as $li){
                   $a++;
              ?>
                    <tr>
                      <td><?php echo $li['id_livraison']; ?></td>
                      <td class="numeric"><?php echo $li['ide_livreur']; ?></td>
                      <td class="numeric"><?php echo $li['id_client']; ?></td>
                      <td class="numeric"><?php echo $li['day']; ?></td>
                      <td class="numeric"><?php echo $li['etat']; ?></td>
                      <td class="numeric"><?php echo $li['id_commande']; ?></td>
                      <td>
                      <a href="modifier_livraison.php?id_livraison=<?php echo $li['id_livraison']; ?>
                      "><button type="submit" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                      <a href="recuperation/supprimer_livraison.php?id_livraison=<?php echo $li['id_livraison']; ?>"><button type="submit" class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
                      </td>
                    </tr>
                    <?php
              }
