      ...
      <section class="wrapper">
       <form name="myform" action="recuperation/ajouter_livreur.php" method="POST">
              <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  <tr>
                    <td><input type="text" name="id_livreur"></td>
                    <td><input type="text" name="nom_livreur"></td>
                    <td><input type="text" name="prenom_livreur"></td>
                    <td><input type="file" name="image_livreur"></td>
                    <td><input type="text" name="email_livreur"></td>
                    <td><input type="text" name="adresse"></td>
                    <td><input type="text" name="telephone"></td>
                    <td>
                      <input class="btn btn-success btn-xs" type="submit" name="ajouter" value="ajouter">
                    </td>
                  </tr>
                </tbody>
              </table>
...
$query = 'SELECT SQL_CALC_FOUND_ROWS * FROM ghostoptique.livreur ORDER BY nom_livreur DESC LIMIT :limite OFFSET :debut';
