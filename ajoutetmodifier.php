...
$produit = $produitC1->getProduitById($product_id);
        ...
        <!-- DATE TIME PICKERS -->
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <form name="f" action="ajoutpromotion.php" method="POST" onsubmit="verif()" class="form-horizontal style-form">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <button type="submit"  onclick="verif()" class="btn btn-theme">AJOUT</button>
