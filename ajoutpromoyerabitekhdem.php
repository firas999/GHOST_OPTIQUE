...
$product_name= $p->getNameProduct();
*/

$product_name= "Lunette Noir";
?>
        ...
        <!-- DATE TIME PICKERS -->
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <form action="ajoutpromotion.php" method="POST" class="form-horizontal style-form">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input  name="solde" size="20" type="text" value="">
                  </div>
                </div>
               
                  <button type="submit" class="btn btn-theme">AJOUT</button>
