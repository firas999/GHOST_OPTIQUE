...
$listeproduis=$produit1C->afficherproduits();
/*
    echo '<pre>';
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i> ID</h4>
                <hr>
                <thead>
                  <tr>
                    <th><i class="fa fa-bullhorn"></i> NOM PRODUIT </th>
                    <th class="hidden-phone"><i class="fa fa-question-circle"></i>PRIX</th>
                    <th><i class="fa fa-bookmark"></i> DATE QUANTITE</th>
                    <th><i class=" fa fa-edit"></i> COULEUR </th>
                  </tr>
...
foreach($listeproduis as $row){
  ...
  <td><a href="ajoutetmodifier.php?id=<?PHP echo $row['id']; ?>"  class="btn btn-theme04">Ajouter Promotion</a></td>
  </tr>
